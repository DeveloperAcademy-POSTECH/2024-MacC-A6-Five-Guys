...
enum PreviewBookFixtureFactory {
    static func makeBook(
        ...
        let recordKey = today.readingDateKey.rawValue
...
extension PreviewSupport {
    ...
    static func makeBook(
        ...
        PreviewBookFixtureFactory.makeBook(
            title: title,
            isCompleted: isCompleted,
            coverImageURL: coverImageURL,
            targetEndDateOffset: targetEndDateOffset,
            lastReadPage: lastReadPage,
            reviewAfterCompletion: reviewAfterCompletion
        )
    }
}
#endif
